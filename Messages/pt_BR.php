 ...
 *
 */
    'repModuleTelegramProvider' => 'Provedor de telegram - %repesent%',
    'mo_ModuleModuleTelegramProvider' => 'Provedor de telegram',
    'BreadcrumbModuleTelegramProvider' => 'Provedor de telegram',
    'SubHeaderModuleTelegramProvider' => 'Conectando um canal do Telegram para chamadas recebidas e efetuadas',
    'module_telegram_AddNewRecord' => 'Adicionar',
    'module_telegram_provider_phone_number' => 'Número de telefone',
    ...
    'module_telegram_providerError' => 'Ocorreu um erro ao tentar fazer login',
    'module_telegram_providerReconnect' => 'Tente conectar novamente...',
    'module_telegram_providerIntegerFieldLabel' => 'Um exemplo de campo numérico',
    'module_telegram_providerCheckBoxFieldLabel' => 'Caixa de seleção',
    'module_telegram_providerToggleFieldLabel' => 'Trocar',
    'module_telegram_providerDropDownFieldLabel' => 'Menu suspenso',
    'module_telegram_providerValidateValueIsEmpty' => 'Verifique o campo, está vazio',
    'module_telegram_providerConnected' => 'As linhas estão conectadas',
    'module_telegram_providerCopy' => 'Copiar para a area de transferência',
    'module_telegram_providerDisconnected' => 'Módulo desativado',
    'module_telegram_providerNotAllConnected' => 'Nem todas as linhas estão conectadas',
    'module_telegram_providerUpdateStatus' => 'Atualização de status',
    ...
    'module_telegram_provider_gw' => 'Gateway Telegram <-> SIP',
